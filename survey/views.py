...
def project_response(request, project_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # TODO: instead, use Project.get_questions()
...
def show_project(request, project_id):
    ...
    responses = ProjectResponse.objects.filter(project=project)
    ...
    return render(request, 'survey/project_results.html', {'title' : title, "num_responses": num_responses, "question_summaries": question_summaries})
